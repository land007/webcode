...
const translations = {
  'zh-CN': {
    ...
    docker_help_mac_step3: '启动 Docker Desktop，等待菜单栏图标稳定（显示为运行状态）',
    docker_help_mac_note: '注意：首次安装后可能需要重启终端或本启动器，以便系统识别 Docker 命令。',
    ...
    docker_help_win_note: '注意：确保已启用 WSL2 功能，并且 Docker Desktop 已正确启动。',
    ...
    dyn_not_found:    '未找到',
    dyn_docker_not_found: '未找到 Docker 命令。请确保已安装 Docker Desktop 并添加到系统 PATH。',
    dyn_docker_path_error: '无法找到 Docker，请检查 Docker Desktop 是否正确安装。',
    dyn_running:      '运行中',
    dyn_not_running:  '未运行',
    dyn_stopped:      '已停止',
    dyn_launch_ok:    '\n✓ 容器启动成功！\n',
    ...
    update_confirm_title:    '确认运行最新容器',
    update_confirm_will:     '更新容器将会：',
    update_confirm_step1:    '停止并删除当前容器',
    update_confirm_step2:    '拉取最新镜像',
    update_confirm_step3:    '重新创建并启动容器',
    update_confirm_backup_title: '请确保以下数据已备份',
    update_confirm_backup_projects: '项目代码',
    update_confirm_backup_dna: 'DNA 源码',
    update_confirm_backup_theia: 'Theia 配置',
    update_confirm_backup_other: '其他重要数据',
    update_confirm_volumes_note: '注意：所有命名卷（projects、dna-data、theia-data 等）会保留，但建议提前备份以防万一。',
    ...
    update_checking_launcher:  '检查启动器版本...',
  ...
  'en': {
    ...
    docker_help_mac_step3: 'Launch Docker Desktop and wait for the menu bar icon to stabilize (showing as running)',
    docker_help_mac_note: 'Note: After first installation, you may need to restart your terminal or this launcher for the system to recognize the Docker command.',
    ...
    docker_help_win_note: 'Note: Ensure WSL2 feature is enabled and Docker Desktop is started correctly.',
    ...
    label_vnc_password:  'System password',
    label_openclaw_token: 'OpenClaw Token',
    ...
    dyn_docker_not_found: 'Docker command not found. Please ensure Docker Desktop is installed and in your system PATH.',
    dyn_docker_path_error: 'Cannot find Docker. Please check if Docker Desktop is correctly installed.',
    dyn_running:      'Running',
    ...
    update_confirm_title:    'Confirm Run Latest Container',
    update_confirm_will:     'The container update will:',
    update_confirm_step1:    'Stop and remove current container',
    update_confirm_step2:    'Pull the latest image',
    update_confirm_step3:    'Recreate and start container',
    update_confirm_backup_title: 'Please ensure the following data is backed up',
    update_confirm_backup_projects: 'Project code',
    update_confirm_backup_dna: 'DNA source code',
    update_confirm_backup_theia: 'Theia configuration',
    update_confirm_backup_other: 'Other important data',
    update_confirm_volumes_note: 'Note: All named volumes (projects, dna-data, theia-data, etc.) will be preserved, but backing up in advance is recommended.',
    ...
    update_checking_launcher:  'Checking launcher version...',
